...
TODO (current version):
  ...
  - Make all the jobs tasks & rewards from level 1 -> 5 : FIGHTER, FARMER, MINER, FISHERMAN remains: TAMER, HUNTER/TRAVELER then tweak or change to make it funnier according to `REWORK` section
