...
## Summary :
A 1.12.2 Minecraft Mod (ver 1.0.0 dev) adding custom minerals, blocks, items, machines and the main plot of the mod is going through the lore of the `Ancient Forgotten City Of Shadows/Chaos`.
