...
public class GuiInventoryExtended extends GuiInventory {
	...
	public static final ResourceLocation BUTTON_TEXTURE_ = new ResourceLocation(
			"chaosmod:textures/gui/container/button_icons.png");
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		if (showAccessorySlot) {
			...
			drawModalRectWithCustomSizedTexture(this.guiLeft, // x
					this.guiTop - 24, // y
					0, 0, // u, v
					64, 24, // width, height
		...
		// this.drawTexturedModalRect(this.guiLeft - 12 - (32 / 2), this.guiTop - 16 -
		// (32/2), 0, 0, 32, 32);
	}
	...
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
		...
		if (slot instanceof SlotAccessory && !((SlotAccessory) slot).visible
				|| (slot instanceof SlotShield && !((SlotShield) slot).visible)) {
			return;
		}
