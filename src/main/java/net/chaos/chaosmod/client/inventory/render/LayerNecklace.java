...
public class LayerNecklace implements LayerRenderer<AbstractClientPlayer> {
    ...
    public void doRenderLayer(AbstractClientPlayer player, float limbSwing, float limbSwingAmount, float partialTicks,
        ...
        if (necklaceStack.getItem() instanceof OxoniumNecklace) {
        	Minecraft.getMinecraft().getTextureManager().bindTexture(NECKLACE_TEXTURE);
        } else if (necklaceStack.getItem() instanceof AllemaniteNecklace) {
        	Minecraft.getMinecraft().getTextureManager().bindTexture(ALLEMANITE_TEXTURE);
        } else if (necklaceStack.getItem() instanceof EnderiteNecklace) {
        	Minecraft.getMinecraft().getTextureManager().bindTexture(ENDERITE_TEXTURE);
        }
