...
public class GuiChaosMath extends GuiMainMenu {
	private static final Logger LOGGER = LogManager.getLogger();
	private static final Random RANDOM = new Random();
	/**
	 * A random number between 0.0 and 1.0, used to determine if the title screen
	 * says
	 * <a href="https://minecraft.gamepedia.com/Menu_screen#Minceraft">Minceraft</a>
	...
	private static final ResourceLocation CUSTOM_TITLE_TEXTURES = new ResourceLocation(Reference.MODID,
			"textures/gui/title/chaosxmathsmod.png");
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.mc.getTextureManager().bindTexture(CUSTOM_TITLE_TEXTURES);
		GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
		...
		this.splashText = net.minecraftforge.client.ForgeHooksClient.renderMainMenu(this, this.fontRenderer, this.width,
				this.height, this.splashText);
