...
public class DimensionGenerator implements IChunkGenerator {
    ...
    private CustomWoodlandMansion woodlandMansionGenerator = new CustomWoodlandMansion(this);
    ...
    {
        {
            ...
            woodlandMansionGenerator = (CustomWoodlandMansion)net.minecraftforge.event.terraingen.TerrainGen.getModdedMapGen(woodlandMansionGenerator, net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.WOODLAND_MANSION);
        }
        this.world = worldIn;
