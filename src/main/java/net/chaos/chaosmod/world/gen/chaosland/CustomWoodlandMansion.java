...
public class CustomWoodlandMansion extends MapGenStructure {
	...
	public CustomWoodlandMansion(IChunkGenerator providerIn)
	{
	...
	{
		return new CustomWoodlandMansion.Start(this.world, this.provider, this.rand, chunkX, chunkZ);
	}
	...
	public static class Start extends StructureStart
	{
		...
		public Start(World p_i47235_1_, IChunkGenerator provider, Random p_i47235_3_, int p_i47235_4_, int p_i47235_5_)
		{
			super(p_i47235_4_, p_i47235_5_);
			this.create(p_i47235_1_, (DimensionGenerator) provider, p_i47235_3_, p_i47235_4_, p_i47235_5_);
		}

		private void create(World p_191092_1_, DimensionGenerator p_191092_2_, Random p_191092_3_, int p_191092_4_, int p_191092_5_)
		{
