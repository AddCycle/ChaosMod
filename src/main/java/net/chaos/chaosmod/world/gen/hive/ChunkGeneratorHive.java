...
public class ChunkGeneratorHive implements IChunkGenerator {
    ...
    public ChunkGeneratorHive(World worldIn, long seed)
    {
        this.world = worldIn;
    ...
    public void buildSurfaces(int p_185937_1_, int p_185937_2_, ChunkPrimer primer)
    {
        ...
        for (int j = 0; j < 16; ++j)
        {
            for (int k = 0; k < 16; ++k)
            {
                ...
                int i1 = -1;
                IBlockState iblockstate = HONEYCOMB;
                IBlockState iblockstate1 = HONEYCOMB;
