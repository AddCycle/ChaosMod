...
public enum ChaosMasterSpawnManager
{
    ...
    private ChaosMasterSpawnManager()
    {
    }

    public abstract void process(WorldServer worldIn, CMFightManager manager, List<EntityEnderCrystal> crystals, int ticks, BlockPos pos);
}
