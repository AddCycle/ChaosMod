...
public class CMPhaseHoldingPattern extends CMPhaseBase
{
    private Path currentPath;
    private Vec3d targetLocation;
    private boolean clockwise;

    public CMPhaseHoldingPattern(ChaosMasterBoss dragonIn)
    {
        super(dragonIn);
    }

    public CMPhaseList<CMPhaseHoldingPattern> getType()
    {
        return CMPhaseList.HOLDING_PATTERN;
    }
    ...
    private void findNewTarget()
    {
        if (this.currentPath != null && this.currentPath.isFinished())
        {
            ...
            {
                this.dragon.getPhaseManager().setPhase(CMPhaseList.LANDING_APPROACH);
                return;
            }
    ...
    {
        this.dragon.getPhaseManager().setPhase(CMPhaseList.STRAFE_PLAYER);
        ((CMPhaseStrafePlayer)this.dragon.getPhaseManager().getPhase(CMPhaseList.STRAFE_PLAYER)).setTarget(player);
    }
