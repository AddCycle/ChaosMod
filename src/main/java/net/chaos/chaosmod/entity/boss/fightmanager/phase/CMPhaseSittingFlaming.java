...
public class CMPhaseSittingFlaming extends CMPhaseSittingBase
{
    private int flameTicks;
    private int flameCount;
    private EntityAreaEffectCloud areaEffectCloud;

    public CMPhaseSittingFlaming(ChaosMasterBoss dragonIn)
    {
        super(dragonIn);
    }
    ...
    public CMPhaseList<CMPhaseSittingFlaming> getType()
    {
        return CMPhaseList.SITTING_FLAMING;
    }
