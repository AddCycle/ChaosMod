...
public class EntityEyeCrystalBossRenderer extends Render<EntityEyeCrystalBoss> {
	...
	private static final ResourceLocation ENDER_CRYSTAL_TEXTURES = new ResourceLocation(Reference.MODID, "textures/entity/boss/eye_of_truth_layer_1.png");
	private static final ResourceLocation ENDER_CRYSTAL_PHASE_2 = new ResourceLocation(Reference.MODID, "textures/entity/boss/eye_of_truth_layer_2.png");
    ...
    public EntityEyeCrystalBossRenderer(RenderManager renderManagerIn) {
     ...
     */
    public void doRender(EntityEyeCrystalBoss entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        float health = entity.getDataManager().get(EntityEyeCrystalBoss.CLIENT_HEALTH);
        float max_health = entity.getDataManager().get(EntityEyeCrystalBoss.CLIENT_MAX_HEALTH);
        ...
        int targetId = entity.getDataManager().get(EntityEyeCrystalBoss.LASER_TARGET_ID);
...
//            	l = 128 - (int)(f7 * 64.0F);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityEyeCrystalBoss entity)
    {
        return ENDER_CRYSTAL_TEXTURES;
    }

    public boolean shouldRender(EntityEyeCrystalBoss livingEntity, ICamera camera, double camX, double camY, double camZ)
    {
