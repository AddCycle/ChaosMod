...
public class CMRenderer extends RenderLiving<ChaosMasterBoss> {
    ...
    {
        super(renderManagerIn, new ChaosMasterModel(0.0F), 0.5F);
        this.addLayer(new LayerCMEyes(this));
        this.addLayer(new LayerDeathBoss<ChaosMasterBoss>(this, 0, 0, 0));
    }

    protected void applyRotations(ChaosMasterBoss entityLiving, float p_77043_2_, float rotationYaw, float partialTicks)
    {
     ...
     */
    protected void renderModel(ChaosMasterBoss entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor)
    {
     ...
     */
    public void doRender(ChaosMasterBoss entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(ChaosMasterBoss entity)
    {
