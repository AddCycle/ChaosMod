package net.chaos.chaosmod.entity.painting.render;
...
public class RenderCustomPainting extends Render<EntityCustomPainting> {

    private static final ResourceLocation ADDCYCLE_PAINTING_TEXTURE = new ResourceLocation(Reference.MODID, "textures/painting/custom_paintings.png");
    ...
    @Override
    public void doRender(EntityCustomPainting entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        EntityCustomPainting.EnumCustomArt entitypainting$enumart = entity.art;
        float f = 0.0625F;
    ...
    {
        return ADDCYCLE_PAINTING_TEXTURE;
    }

    private void renderPainting(EntityCustomPainting painting, int width, int height, int textureU, int textureV)
    {
    ...
    private void setLightmap(EntityCustomPainting painting, float p_77008_2_, float p_77008_3_)
    {
