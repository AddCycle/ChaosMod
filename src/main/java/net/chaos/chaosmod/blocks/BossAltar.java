...
import net.chaos.chaosmod.network.packets.PacketCutscene;
...
public class BossAltar extends Block implements ITileEntityProvider, IBlockModel {
	/*
	 * From 0 -> 3 : 0 = Mountain Giant -1 = Blaze 1 = Eye of truth 2 = Chaos
	 * Master, Spawning on himself
	 */
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (te instanceof TileEntityBossAltar) {
			...
			if (hand.equals(EnumHand.MAIN_HAND)
					&& playerIn.getHeldItemMainhand().isItemEqual(new ItemStack(ModItems.OXONIUM_INGOT))) {
				te_2.r = 0.001f;
				te_2.g = 0.0f;
				te_2.b = 1.0f;
				bossType = 0;
			} else if (hand.equals(EnumHand.MAIN_HAND)
					&& playerIn.getHeldItemMainhand().isItemEqual(new ItemStack(ModItems.GIANT_HEART))) {
				bossType = -1;
				te_2.r = 1.0f;
				te_2.g = 0.0f;
				te_2.b = 0.0f;
			} else if (hand.equals(EnumHand.MAIN_HAND)
					&& playerIn.getHeldItemMainhand().isItemEqual(new ItemStack(ModItems.BLAZING_HEART))) {
				bossType = 1;
				te_2.r = 0.5f;
				te_2.g = 0.0f;
				te_2.b = 0.5f;
			...
			if (!worldIn.isRemote) {
				PacketManager.network.sendToAll(new PacketCutscene(pos.north(20).up(2)));
