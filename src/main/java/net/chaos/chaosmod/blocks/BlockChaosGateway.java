...
public class BlockChaosGateway extends BlockContainer implements IHasModel {
    ...
    {
        return new TileEntityChaosGateway();
    }
    ...
    public boolean shouldSideBeRendered(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
        ...
        return !iblockstate.isOpaqueCube() && block != ModBlocks.CHAOS_GATEWAY;
    }
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand)
    {
        ...
        {
            int i = ((TileEntityChaosGateway)tileentity).getParticleAmount();
