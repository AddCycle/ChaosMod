...
public class LitFurnace extends BlockContainer {
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        {
            worldIn.setBlockState(pos, ModBlocks.OXONIUM_FURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.OXONIUM_FURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityOxoniumFurnace)
            {
                ((TileEntityOxoniumFurnace)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        if (!keepInventory)
        {
            ...
            if (tileentity instanceof TileEntityOxoniumFurnace)
            {
                InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityOxoniumFurnace)tileentity);
    ...
    {
        return new ItemStack(ModBlocks.OXONIUM_FURNACE);
    }
