...
public class ModelBakeEventHandler {
	public static final ModelBakeEventHandler instance = new ModelBakeEventHandler();
	  ...
	  public static void onModelBakeEvent(ModelBakeEvent event)
	  {
	    ...
	    Object object =  event.getModelRegistry().getObject(ShapeShiftingBakedModel.variantTag);
	    if (object instanceof IBakedModel) {
	      IBakedModel existingModel = (IBakedModel)object;
	      ShapeShiftingBakedModel customModel = new ShapeShiftingBakedModel(existingModel);
	      event.getModelRegistry().putObject(ShapeShiftingBakedModel.variantTag, customModel);
	    }
	  }
