...
public class AbstractDoor extends Block implements IHasModel {
    ...
    {
        if ((Block) this == Blocks.IRON_DOOR)
        {
            return Items.IRON_DOOR;
        }
        else if ((Block) this == Blocks.SPRUCE_DOOR)
        {
            return Items.SPRUCE_DOOR;
        }
        else if ((Block) this == Blocks.BIRCH_DOOR)
        {
            return Items.BIRCH_DOOR;
        }
        else if ((Block) this == Blocks.JUNGLE_DOOR)
        {
            return Items.JUNGLE_DOOR;
        }
        else if ((Block) this == Blocks.ACACIA_DOOR)
        {
            return Items.ACACIA_DOOR;
        }
        else
        {
            return (Block) this == Blocks.DARK_OAK_DOOR ? Items.DARK_OAK_DOOR : Items.OAK_DOOR;
        }
    }
