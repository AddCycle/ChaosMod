...
public class OxoniumChestContainer extends Container {

    private final IInventory lowerChestInventory;
    private final int numRows;

    public OxoniumChestContainer(IInventory playerInventory, IInventory chestInventory, EntityPlayer player)
    {
